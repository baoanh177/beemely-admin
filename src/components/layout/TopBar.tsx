...
const TopBar = () => {
  ...
  return (
    <div className="sticky left-0 right-0 top-0 z-20 bg-gray-25 p-6 pb-2">
      <div className="flex h-12 items-center justify-between gap-4 rounded-lg bg-white p-2 shadow">
        {/* Search */}
